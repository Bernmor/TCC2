...
srcVidPath=['C:\Users\Bernardo\Documents\2019_1\TCC 2\Videos\UTD\',num2str(vidID),'.mp4']

%path to output video
dstVidPath=['C:\Users\Bernardo\Documents\2019_1\TCC 2\Videos\H', num2str(vidID), '.avi']

%path to viewport traces in the dataset
tracePath='C:\Users\Bernardo\Documents\2019_1\TCC 2\Traces\';

pathmap = 'C:\Users\Bernardo\Documents\2019_1\TCC 2\Heatmaps\UTD\';
%% Parameters
%output video size
outWidth=1920/4;
outHeight=1080/4;
...
close(videoWriter);
filename = [pathmap, num2str(vidID),  '_Heatmap']
save(filename,'maps');